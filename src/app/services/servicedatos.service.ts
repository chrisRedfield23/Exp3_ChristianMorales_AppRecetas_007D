...
export class ServicedatosService {
  ...
  constructor(private storage: Storage) {
   ...
   //definimos en un metodo la creaciòn del almacenamiento
   async init(){
    ...
    //implementacion de metodos de manipulacion de storage

    //agregar objeto a coleccion
  ...
  //Leer, obtener informaciòn almacenada en storage
  getDatos(): Promise<Datos[]>{
    return this.storage.get(ITEMS_KEY);
  }


  //actualizar informaciòn de un objeto
